...
<html lang="en">
	<head>
		...
		<title>SISTEMA RESTAURANTE UNIVERSITÁRIO</title>
		<!-- Bootstrap core CSS -->
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="container">
				...
				<div class="navbar-header page-scroll">
					...
					<a class="navbar-brand page-scroll" href="#page-top"><img src="<?php echo base_url(); ?>public/images/SRU.png" alt="Lattes theme logo"></a>
				</div>
			...
			<div class="container">
				<div class="slider-container">
					<div class="intro-text">
						<div class="intro-lead-in">Bem Vindo ao Sistema de Gerência do Restaurante Universitário</div>
						<div class="intro-heading">SRU</div>
						<a href="#about" class="page-scroll btn btn-xl">IF Goiano - CAMPUS CERES</a>
					</div>
				</div>
			</div>
		</header>
