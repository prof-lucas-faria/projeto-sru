                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="data" id="data" class="form-control" autofocus='true'
                                       requiried="true" value="<?php set_value('data') ?>"/>
                            </div>
                            <div class="form-group">
                                <?php echo form_error('nomeCardapio'); ?>
                                <label for="nomeCardapio">Nome :</label>
                                <input type="text" name="nomeCardapio" id="nomeCardapio" class="form-control"
                                       autofocus='true' requiried="true"/>
                            </div>
                            <div class="form-group ">
                                ...
                                <input type="text" name="pratoPrincipal" id="pratoPrincipal" class="form-control"
                                       value="<?= set_value('pratoPrincipal') ?>"/>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="guarnicao" name="guarnicao" id="guarnicao" class="form-control"
                                       value="<?= set_value('guarnicao') ?>"/>
                            </div>
                            <div class="form-group">
                                <?php echo form_error('acompanhamento'); ?>
                                <label for="acompanhamento">Acompanhamento</label>
                                <input type="acompanhamento" name="acompanhamento" id="acompanhamento"
                                       class="form-control" value="<?= set_value('acompanhamento') ?>">
                            </div>
                            <div class="form-group">
                                <?php echo form_error('salada'); ?>
                                <label for="salada">Salada</label>
                                <input type="salada" name="salada" id="salada" class="form-control"
                                       value="<?= set_value('salada') ?>"/>
                            </div>
                            <div class="form-group">
                                <?php echo form_error('sobremesa'); ?>
                                <label for="sobremesa">Sobremesa</label>
                                <input type="sobremesa" name="sobremesa" id="sobremesa"
                                       value="<?= set_value('sobremesa') ?>" class="form-control"/>
                            </div>
                            <div class="form-group">
                                <?php echo form_error('suco'); ?>
                                <label for="suco">Suco</label>
                                <input type="suco" name="suco" id="suco" value="<?= set_value('suco') ?>"
                                       class="form-control"/>
                            </div>
                            ...
                            <input type='hidden' name="id"
                                   value="<?= set_value('id') ?: (isset($idCardapio) ? $idCardapio : ''); ?>">
                            <?= form_close(); ?>
                        </div>
                        <div class="row">
                            <hr>
